...
export default function Navigation() {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      const response = await axios.get('/api/notifications', { signal: controller.signal, timeout: 10000 });
      clearTimeout(timer);
    ...
    <motion.div
      ...
      animate={{
        ...
        boxShadow: isScrolled 
          ? '0 8px 32px rgba(0, 0, 0, 0.12), 0 0 0 1px rgba(99, 102, 241, 0.05)'
          ...
          >
            <Typography 
              ...
              sx={{ 
                ...
                color: 'inherit',
                fontWeight: 800,
                background: 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 30%, #ec4899 70%, #10b981 100%)',
            ...
            >
              <Button
                ...
                startIcon={<motion.div 
                  animate={{ 
                    rotate: pathname === item.path ? [0, -10, 10, 0] : 0,
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    boxShadow: '0 8px 25px rgba(99, 102, 241, 0.25), 0 4px 12px rgba(0, 0, 0, 0.15)',
                    '&::before': {
                      opacity: 1
                    }
                  },
