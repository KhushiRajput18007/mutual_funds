...
import { ScrollToTop, AccessibilityPanel } from '../components/AccessibilityEnhancements';
...
export const metadata = {
  ...
  // Icons are handled automatically by Next.js App Router from src/app/
  // favicon.ico and icon.svg files
  keywords: [
    'mutual funds',
    'SIP calculator',
    'investment planning',
